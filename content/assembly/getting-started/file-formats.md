...
1. [Supported Multipurpose Document Formats]({{< param url >}}/#supported-multipurpose-document-formats)
    * [Microsoft Office Word Documents]({{< param url >}}/#microsoft-office-word-documents)
    * [Microsoft Office Excel Documents]({{< param url >}}/#microsoft-office-excel-documents)
    * [Microsoft Office PowerPoint Documents]({{< param url >}}/#microsoft-office-powerpoint-documents)
    * [OpenOffice Documents]({{< param url >}}/#openoffice-documents)
    * [Email Documents]({{< param url >}}/#email-documents)
    * [Web Documents]({{< param url >}}/#web-documents)
2. [Supported Export-Only File Formats]({{< param url >}}/#supported-export-only-file-formats)
    * [Adobe Documents]({{< param url >}}/#adobe-documents)
    * [Printing Language Documents]({{< param url >}}/#printing-language-documents)
    * [Vector Images]({{< param url >}}/#vector-images)
    * [Bitmap Images]({{< param url >}}/#bitmap-images)
    * [Other File Formats]({{< param url >}}/#other-file-formats)
...
[comment]: <> (<a href="https://en.wikipedia.org/wiki/Microsoft_Office_XML_formats"> WordprocessingML</a> - XML-based Wordprocessing Markup Language)
...
[comment]: <> (<a href="https://en.wikipedia.org/wiki/SpreadsheetML">SpreadsheetML</a> - XML-based Spreadsheet Markup Language)
...
<table><thead><tr><th style="width: 90px;">Format</th><th>Description</th></tr></thead><tbody><tr><td><a href="https://docs.fileformat.com/view/pdf/">PDF</a></td><td>Adobe Portable Document</td></tr></tbody></table>

### Printing Language Documents

The following printing language document export-only formats are supported:

<table><thead><tr><th style="width: 90px;">Format</th><th>Description</th></tr><thead><tbody><tr><td><a href="https://docs.fileformat.com/page-description-language/pcl/">PCL</a></td><td>Printer Command Language Document</td></tr><tr><td><a href="https://docs.fileformat.com/page-description-language/ps/">PS</a></td><td>PostScript Document</td></tr><tr><td><a href="https://docs.fileformat.com/page-description-language/xps/">XPS</a></td><td>XML Paper Specification Document</td></tr><tr><td>OXPS</td><td>OpenXPS Document</td></tr></tbody></table>

### Vector Images

The following vector image export-only formats are supported:

<table><thead><tr><th style="width: 90px;">Format</th><th>Description</th></tr></thead><tbody><tr><td><a href="https://docs.fileformat.com/page-description-language/svg/">SVG</a></td><td>Scalable Vector Graphics</td></tr><tr><td>EMF</td><td>Enhanced MetaFile Image Format</td></tr></tbody></table>

### Bitmap Images

The following bitmap image export-only formats are supported:

<table><thead><tr><th style="width: 90px;">Format</th><th>Description</th></tr></thead><tbody><tr><td><a href="https://docs.fileformat.com/Image/PNG/">PNG</a></td><td>Portable Graphics Format</td></tr></thead><tbody><tr><td><a href="https://docs.fileformat.com/Image/JPEG/">JPEG</a></td><td>Compressed Image Format</td></tr><tr><td><a href="https://docs.fileformat.com/Image/GIF/">GIF</a></td><td>The Graphics Interchange Format</td></tr><tr><td><a href="https://docs.fileformat.com/Image/TIFF/">TIFF</a></td><td>Tagged Image File Format</td></tr><tr><td><a href="https://docs.fileformat.com/Image/BMP/">BMP</a></td><td>Device-independent Bitmap Format</td></tr></tbody></table>

### Other File Formats

The following other export-only formats are supported:

<table><thead><tr><th style="width: 90px;">Format</th><th>Description</th></tr></thead><tbody><tr><td><a href="https://docs.fileformat.com/web/xaml/">XAML</a></td><td>XML-based Markup Language (WPF, WWF, Silverlight)</td></tr><tr><td><a href="https://docs.fileformat.com/ebook/epub/">EPUB</a></td><td>E-Book File Format</td></tr></tbody></table>