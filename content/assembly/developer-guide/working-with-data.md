...
1.  [Using Variables](#HVar)
2.  [Using Extension Methods](#HExtensions)
    1.  [Using Extension Methods of Iteration Variables](#HIterExtensions)
    2.  [Using Enumeration Extension Methods](#HEnumExtension)
3.  [Data Formatting](#HDataFormatting)
    1.  [Formatting Numeric and DateTime Expressions](#HFormatting)
    2.  [Additional Number Formats](#HAddNumberFormats)
    3.  [Additional String Formats](#HAddStringFormats)
    4.  [Formatting Options Combinations](#HFormatCombinations)
4.  [See Also](#HSeeAlso)
