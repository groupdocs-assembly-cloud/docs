...
1. [Inserting a Hyperlink](/assembly/developer-guide/working-with-other-elements/#inserting-a-hyperlink)
    * [Inserting a Hyperlink into a Word-Processing Document or Email](/assembly/developer-guide/working-with-other-elements/#inserting-a-hyperlink-into-a-word-processing-document-or-email)
    * [Inserting a Hyperlink into a Spreadsheet](/assembly/developer-guide/working-with-other-elements/#inserting-a-hyperlink-into-a-spreadsheet)
    * [Inserting a Hyperlink into a Presentation](/assembly/developer-guide/working-with-other-elements/#inserting-a-hyperlink-into-a-presentation)
...
4. [Generating and Inserting a Barcode Image](/assembly/developer-guide/working-with-other-elements/#generating-and-inserting-a-barcode-image)
    * [Setting a Barcode Type](/assembly/developer-guide/working-with-other-elements/#setting-a-barcode-type)
